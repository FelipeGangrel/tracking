...
public class Localizacao implements LocationListener {
    ...
    private static Localizacao instance = null;
     ...
     * @return
     */
    public static Localizacao getLocationManager(Context context)     {
        if (instance == null) {
            instance = new Localizacao(context);
        }
        return instance;
    }
    ...
    @Override
    public void onStatusChanged(String provider, int statusId, Bundle extras){
